...
🎥 **[Watch the problem](https://www.dropbox.com/scl/fi/k8dnd1u92kd9obf348uq6/bad-img-loading.mp4?rlkey=aois484ivmdjne5n7diorc7xy&raw=1)** — the ship name and stats change, but the image lags far behind.
...
* [`use()` React hook](https://react.dev/reference/react/use)
